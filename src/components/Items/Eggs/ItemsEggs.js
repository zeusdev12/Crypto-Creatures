    ...
    <div className={classes.root}>
      {
        NFTS.eggs.length > 0
        ? <>
            <ViewBar name="Egg" switchViewMode={switchViewMode} viewMode={viewMode} totalCount={NFTS.eggs.length}/>
            { viewMode == false ? <ThumbView data={NFTS.eggs} name="Egg"/> : <ListView data={NFTS.eggs} name="Egg"/> }
            <PaginationComponent/>
          </>

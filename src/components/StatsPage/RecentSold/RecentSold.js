...
import RecentSoldBox from "./RecentSoldBox";
...
const Statistic = (props) => {
  ...
  return (
    <div className={classes.root}>
      <p className={classes.title}>Recently Sold</p>
      <div className={classes.table}>
        ...
        <TabPanel value={value} index={0}>
          <RecentSoldBox data={Array(5).fill(0)} index={value}/>
        </TabPanel>
        <TabPanel value={value} index={1}>
          <RecentSoldBox data={Array(3).fill(0)} index={value}/>
        </TabPanel>
        <TabPanel value={value} index={2}>
          <RecentSoldBox data={Array(4).fill(0)} index={value}/>
        </TabPanel>
      </div>
    </div>
  );

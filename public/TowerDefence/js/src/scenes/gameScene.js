    ...
    constructor(scene, camera) {
        ...
        effectsImageButton.addEventListener("click", (event) => {
            ...
            if (soundEffectsVolume == 0) {
                effectsImageButton.src = "TowerDefence/assets/images/volume_off.png";
            } else {
                effectsImageButton.src = "TowerDefence/assets/images/volume_up.png";
            }
        });
        ...
        musicImageButton.addEventListener("click", (event) => {
            toggleMusicPlay();
            if (!isPlayingMusic) {
                musicImageButton.src = "TowerDefence/assets/images/volume_off.png";
            } else {
                musicImageButton.src = "TowerDefence/assets/images/volume_up.png";
            }
        });
        ...
        this.orbitControls.minAzimuthAngle = - Math.PI / 4; // radians
